package fr.gaelcarre.twitterlist.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("twitterlist");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("twitterlist");
        ...
        config.getMapConfigs().put("fr.gaelcarre.twitterlist.domain.*", initializeDomainMapConfig(jHipsterProperties));
